...
---@param delim? string
---@return string
function Stream:join(delim) return table.concat(self:toarray(), delim) end
...
function Stream:unpack() return unpack(self:toarray()) end
...
function Stream.empty() return Stream.new(nil) end

---Returns a new stream containing the elements passed as parameters
---@param ... unknown
function Stream.of(...) return Stream.new(pack(...)) end
...
local mt = {}
function mt:__call(...) return Stream.new(...) end
